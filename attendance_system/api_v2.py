...
CORS(app, resources={r"/api/*": {"origins": ["*","https://e633-41-210-147-207.ngrok-free.app","https://biometric-facial-recognition-attendance-system.vercel.app"], "allow_headers": ["Content-Type", "Authorization", "ngrok-skip-browser-warning"], "methods": ["GET", "POST", "PUT", "DELETE"]}})
# Configuration
